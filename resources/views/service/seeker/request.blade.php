...
<div class="container">
  ...
  <form action="{{ route('service.create.done') }}" method="post" class="form-control" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      <label for="content" class="fw-bolder">依頼内容</label>
    ...
    <div class="mb-3">
      <label for="area_id" class="fw-bolder">エリア(複数選択可能)※任意</label>
      <div>
    ...
    <div class="mb-3">
      <label for="attention" class="fw-bolder">その他自由記入※任意</label>
      <div class="input-group">
        <textarea name="free" class="text-start input-group-text is-valid" style="resize: none; height: 70px; overflow-y: auto; padding: 10px; width: 100%;" oninput="this.style.height = '70px'; this.style.height = (this.scrollHeight + 10) + 'px';" placeholder="Enterで送信。Shift+Enterで改行"></textarea>
      </div>
    </div>

    <div class="mb-3">
      <label for="price" class="fw-bolder">予算(税別)<span>物品購入などのサービスに付随し発生する費用も全て含めた支払い総額</span></label>
      <div class="input-group">
    ...
    <div class="mb-3">
      <label for="application_deadline" class="fw-bolder">応募締切日</label>
      <div class="input-group">
    ...
    <div class="mb-3">
      <label for="delivery_deadline" class="fw-bolder">納品締切日</label>
      <div class="input-group">
    ...
    <div class="mb-3">
      ...
      <div class="form-check form-switch">
        <input class="form-check-input" type="radio" id="public_radio" name="public_sign" value="public" checked>
        <label class="form-check-label" for="public_radio">公開</label>
      </div>

      <div class="form-check form-switch">
        <input class="form-check-input" type="radio" id="private_radio" name="public_sign" value="private">
