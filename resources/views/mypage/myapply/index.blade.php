...
<div class="container">
  <div class="col-10">
    ...
    <div class="mb-5 mb-lg-0 text-center text-lg-start">
      ...
      <button onClick="location.href='{{ route('pubreq.detail',['service_id'=>$item->id]) }}'" class="card m-4 shadow card-point bg-success" style="max-width: 500px;">
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <a href="{{ route('pubreq.detail',['service_id'=>$item->id]) }}" class="btn btn-secondary stretched-link">詳細を見る</a>
