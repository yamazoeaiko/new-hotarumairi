...
<div class="container">
  ...
  <div class="list-group">
    ...
    <button class="list-group-item list-group-action" onClick="location.href='{{route('admin.cancel.detail',['agreement_id'=>$item->id])}}'">
      <div class="no-gutters">
        ...
        <div class="row">
          <span class="fs-7 fw-bolder">購入者</span><span class="fs-6">{{$item->buy_user_name}}</span>
