...
@section('content')
<div class="container">
  <h5 class="my-2 fw-bold fs-5">【管理画面】振込一覧（リクエスト）</h5>
  <div class="d-flex justify-content-around my-2">
    <button class="btn btn-primary" onClick="location.href='{{ route('admin.transfer.offer.list') }}'" disabled>
      リクエスト
    </button>
    <button class="btn btn-outline-primary" onClick="location.href='{{ route('admin.transfer.done.list') }}'">
      振込済み
    </button>
